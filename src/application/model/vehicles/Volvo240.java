...
/**
 * application.application.model.vehicles.Volvo240 is used to create a new volvo object. It is initialized with its position (x, y), and direction. All its other
